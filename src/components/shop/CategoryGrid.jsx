...
const CategoryGrid = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      name: "Electronics",
      image:
        "https://img.freepik.com/free-photo/still-life-wireless-cyberpunk-headphones_23-2151072230.jpg",
    ...
    },
    {
      ...
      name: "Sports & Fitness",
      image:
        "https://plus.unsplash.com/premium_photo-1664536967999-f75d4f4b95fb?q=80&w=1000&auto=format&fit=crop",
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6 ">
        {categories.map((category) => (
          ...
          >
            ...
            {/* Gradient overlay */}
            <div
              className={`absolute inset-0 bg-gradient-to-b ${category.bgColor} z-10`}
            ></div>
            ...
            >
              ...
              <div className="text-center mb-2">
                ...
                <motion.div
                  ...
                  initial={{ scaleX: 0.5 }}
                  animate={{
                    scaleX: hoveredCategory === category.id ? 1 : 0.5,
                  }}
                  transition={{ duration: 0.3 }}
                />
              </div>
            ...
            {hoveredCategory === category.id && (
              <motion.div
                className={`absolute inset-0 rounded-xl shadow-lg ${category.accentColor.replace(
                  "bg",
                  "shadow"
                )} opacity-50 z-0`}
                initial={{ opacity: 0 }}
